...
showMessage('Responsable existe déja !')
else
begin
If  Edit1.Text<>''then
...
//    DataModule2.ADOTable15.FieldByName('CIN').Value:=DBEdit2.Text+' du '+DateTimePicker1.Date+' à '+Edit6.Text;
    ...
    DataModule2.ADOTable15.FieldByName('Mot_de_pass').Value:=Edit1.Text;
