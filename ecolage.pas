    ...
    begin
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              DataModule2.ADOTable7.FieldByName('Mode_payement').Value:='N° Chéque: '+DbEdit1.Text;
            end
            else
            showMessage(uppercase('Merci de precisé la montant versé par chéque!'));
          end
        else
            showMessage(uppercase('Merci de precisé la N° de chéque !'))
        end;
      if Radiobutton2.Checked then
        ...
        begin
          ...
          showMessage('Merci de precisé la montant transferé par réseau!')
        end;
      if RadioButton3.Checked then
        begin
          ...
          showMessage('Merci de precisé la montant !')
        end;
          DataModule2.AdoTable7.FieldByName('Date_payer').Value:=DateTimePicker1.Date;
...
showMessage('Numero Matricule (N°étudiant), incorrect!')
end;
