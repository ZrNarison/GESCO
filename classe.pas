...
if (Edit2.Text<>'') then
  ...
  if (DBEdit1.Text<>'') then
    begin
    if(Edit2.Text+(('éme '))+Uppercase(Edit1.Text)=DataModule2.AdoTable2.FieldByName('Classe').AsString) then
      begin
        ShowMessage('Niveau classe existe déjà !');
        Edit1.Clear;
        Edit2.Clear;
        DBEdit1.Clear;
      end
      ...
      if (ComboBox1.Text='Primaire') then
        ...
        with DataModule2 do
          begin
            ADOTable2.Append;
            AdoTable2.insert;DataModule2.AdoTable2.FieldByName('Classe').Value:=Uppercase(Edit2.Text)+'éme '+Uppercase(Edit1.Text);
        ...
        begin
         if (ComboBox1.Text='Sécondaire prémiere cycle') then
          begin
           DataModule2.ADOTable2.Append;
           DataModule2.AdoTable2.insert;DataModule2.AdoTable2.FieldByName('Classe').Value:=Uppercase(Edit2.Text)+'éme '+Uppercase(Edit1.Text);
        ...
        begin
        if (ComboBox1.Text='Sécondaire séconde cycle') then
          begin
        ...
        if (ComboBox1.Text='Universitaire') then
          begin
            ...
            begin
              DataModule2.ADOTable2.Append;
              DataModule2.AdoTable2.insert;DataModule2.AdoTable2.FieldByName('Classe').Value:=Uppercase(Edit2.Text)+'er'+' Annnées '+Uppercase(Edit1.Text);
              DataModule2.AdoTable2.FieldByName('Tutilaire').Value:=DBLookUpComboBox1.Text;
              DataModule2.AdoTable2.FieldByName('Ecolage').Value:=DBEdit1.Text;
              DataModule2.AdoTable2.Post;
              Edit1.Clear;
        ...
        begin
         DataModule2.ADOTable2.Append;
         DataModule2.AdoTable2.insert;DataModule2.AdoTable2.FieldByName('Classe').Value:=Edit2.Text+'éme'+' Annnées '+Uppercase(Edit1.Text);
         DataModule2.AdoTable2.FieldByName('Tutilaire').Value:=DBLookUpComboBox1.Text;
         DataModule2.AdoTable2.FieldByName('Ecolage').Value:=DBEdit1.Text;
         DataModule2.AdoTable2.Post;
         Edit1.Clear;
...
//Showmessage('Classe supprimé avec succé !');
end;
