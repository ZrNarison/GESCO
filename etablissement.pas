...
begin
  ...
  begin
    showMessage('Ecole déja ouverte !');
    Edit1.Clear;//Nom
    Edit2.Clear;//Nom
    DBEdit1.text:='';//Stat
    DBEdit2.text:='';//nif
...
showMessage('Localisation d''établissement invalide!')
end
else
showMessage('Un école doit avoir une Numéro d''Identité Fiscal (N.I.F)!')
end
else
showMessage('Une école doit avoir une numéro de carte Statistique!')
  end
  else
  showMessage('Aucun nom d''établissement introduit!')
end
else
showMessage('Code d''établissement invalide , Merci de réverifier !')
end;
